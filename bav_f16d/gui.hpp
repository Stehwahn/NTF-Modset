...
{
	idc = 1201;
	text = "FIR_F16D\ui\background_ca.paa";
	x = 0.150016 * safezoneW + safezoneX;
	y = 0.152747 * safezoneH + safezoneY;
	w = 0.699969 * safezoneW;
	h = 0.700106 * safezoneH;
...
{
	idc = 1200;
	text = "FIR_F16D\ui\f16_loadout_ca.paa";
...
{
	idc = 1600;
	text = "FIR_F16D\ui\button_apply.paa";
...
class F16_Apply_Button2: RscButton
{
	...
	action="_applyhandle = execVM ""\FIR_F16D\sqs\loadout\F16_Loadout.sqf""";
};
class F16_Cancel_Button: RscPicture
{
	idc = 1601;
	text = "FIR_F16D\ui\button_cancel.paa";
...
{
	idc = 1010;
	text = "F-16 Loadout"; //--- ToDo: Localize;
	x = 0.158765 * safezoneW + safezoneX;
	y = 0.163949 * safezoneH + safezoneY;
	w = 0.148743 * safezoneW;
	h = 0.0280043 * safezoneH;
};
*/
...
/*
class F16_Combo_3A: RscCombo
{
	idc = 2104;
	x = 0.517499 * safezoneW + safezoneX;
	y = 0.746435 * safezoneH + safezoneY;
	w = 0.0787465 * safezoneW;
	h = 0.0280043 * safezoneH;
};
*/
...
/*
class F16_Combo_7A: RscCombo
{
	idc = 2109;
	x = 0.263752 * safezoneW + safezoneX;
	y = 0.746437 * safezoneH + safezoneY;
	w = 0.0787465 * safezoneW;
	h = 0.0280043 * safezoneH;
};*/
...
{
	idc = 1602;
	text = "FIR_F16D\ui\button_repair.paa";
...
class F16_Repair_Button2: RscButton
{
	...
	action="_repairhandle = execVM ""\FIR_F16D\sqs\loadout\F16_Repair.sqf""";
};
class F16_Refuel_Button: RscPicture
{
	idc = 1603;
	text = "FIR_F16D\ui\button_refuel.paa";
	x = 0.709991 * safezoneW + safezoneX;
...
class F16_Refuel_Button2: RscButton
{
	...
	action="_refuelhandle = execVM ""\FIR_F16D\sqs\loadout\F16_Refuel.sqf""";
};
...
/*class f16_ins_Button: RscPicture
{
	idc = 1705;
	text = "FIR_F16D\ui\button_insignia.paa";
	x = 0.7975 * safezoneW + safezoneX;
	y = 0.626019 * safezoneH + safezoneY;
	w = 0.035 * safezoneW;
	h = 0.056 * safezoneH;
};
class f16_checkins: RscButton
{
	idc = 1604;
	text = ""; //--- ToDo: Localize;
	x = 0.7975 * safezoneW + safezoneX;
	...
	colorBackground[] = {-1,-1,-1,-1};
	colorActive[] = {-1,-1,-1,-1};
	tooltip = "Access ADES"; //--- ToDo: Localize;
	action="_insigniahandle = execVM ""\FIR_AirWeaponSystem_US\Script\ades\ADES_Open.sqf""";
};*/
class f16_custom_save_Buttonpic_1: RscPicture
{
	idc = 1706;
	text = "FIR_F16D\ui\button_save1_ca.paa";
	x = 0.709991 * safezoneW + safezoneX;
...
class f16_custom_save_Button_1: RscButton
{
	...
	action="_custom1handle = execVM ""\FIR_F16D\sqs\loadout\F16_SaveCustom.sqf""";
};
...
/*class f16_custom_save_Buttonpic_3: RscPicture
{
	idc = 1708;
	text = "FIR_F16D\ui\button_save3_ca.paa";
	x = 0.7975 * safezoneW + safezoneX;
	y = 0.57 * safezoneH + safezoneY;
	w = 0.035 * safezoneW;
	h = 0.056 * safezoneH;
};
class f16_custom_save_Button_3: RscButton
{
	idc = 1607;
	text = ""; //--- ToDo: Localize;
	x = 0.7975 * safezoneW + safezoneX;
	...
	colorBackground[] = {-1,-1,-1,-1};
	colorActive[] = {-1,-1,-1,-1};
	tooltip = "Save the Custom Preset in slot 3"; //--- ToDo: Localize;
	action="_custom3handle = [""custom_3""] execVM ""\FIR_F16D\sqs\loadout\F16_SaveCustom.sqf""";
};*/
class f16_name_Buttonpic: RscPicture
{
	idc = 1709;
	text = "FIR_F16D\ui\button_name_ca.paa";
	x = 0.7575 * safezoneW + safezoneX;
	y = 0.626019 * safezoneH + safezoneY;
	w = 0.035 * safezoneW;
	h = 0.056 * safezoneH;
