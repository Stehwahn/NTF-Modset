	class ACE_SelfActions 
		{
			class extendrefueling 
			{
				...
				statement = "_target animate [""fuel_probe"",1];_target animate [""refuel_hatch"",1];_target animate [""refuel_hatch_cft"",1];";
				showDisabled = 0;
				priority = 1;
				icon = "";
			};		
			class retractrefueling 
			{
				...
				statement = "_target animate [""fuel_probe"",0];_target animate [""refuel_hatch"",0];_target animate [""refuel_hatch_cft"",0];";
				showDisabled = 0;
				priority = 1;
				icon = "";				
			};
			...
			class Fueltank_Jettison
			{
				...
				statement = "[_target] execVM ""\FIR_F16D\sqs\Jettison\droptanks.sqf"";";
				showDisabled = 0;
				priority = 1;
				icon = "";
			};
