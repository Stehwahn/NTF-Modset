	class FIR_F16C_Loadout_Module: Module_F
	{
		// Standard object definitions
		scope = 2; // Editor visibility; 2 will show it in the menu, 1 will hide it.
		displayName = "F-16C Loadout Module"; // Name displayed in the menu
	/*	icon = "\myTag_addonName\data\iconNuke_ca.paa";*/ // Map icon. Delete this entry to use the default icon
		category = "ObjectModifiers";

		// Name of function triggered once conditions are met
		function = "FIR_fnc_F16C_Loadout";
...
/*		curatorInfoType = "RscDisplayAttributeModuleF14D";*/
		...
		{
			description = "F-16C Loadout Module"; // Short description, will be formatted as structured text
