		class UserActions
		{
			...
			class Afterburner 
			{
				...
				statement = "this execvm ""\FIR_F16\sqs\FX\F16_FX_Afterburner.sqf"";";
				onlyforplayer = "False";
		        hideOnUse = 1;
				showWindow = 0;
			};
		...
		//		statement = "this setvariable [""ITGT_VT"",""yes""]; [this] execVM ""\FIR_AirWeaponSystem_US\Script\TGTSystem\vt_tracking.sqf"";";
			...
			class TGTPOD_Zoom_Toggle
			{
				...
				radius = 15;
				condition = "this getvariable ""ITGT_VT"" == ""yes""";
				statement = "[this] execVM ""\FIR_F16\sqs\init\TGP_Switch.sqf"";";
				onlyforplayer = "false";
				shortcut = "User7";
		        hideOnUse = 1;
				showWindow = 0;
			...
			class TGTPOD_Mode_Toggle
			{
				...
				radius = 15;
				condition = "this getvariable ""ITGT_VT"" == ""yes""";
				statement = "[this] execVM ""\FIR_F16\sqs\init\TGP_Mode_Switch.sqf"";";
				onlyforplayer = "false";
				shortcut = "User8";
		        hideOnUse = 1;
				showWindow = 0;
