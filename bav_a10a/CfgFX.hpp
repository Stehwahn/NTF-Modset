class CfgCloudlets 
{
	...
	class A10_WingTrailMed: Default
	{
		interval = "0.0001 * (accelY interpolate [39.9999999,40,-1,1])";
		circleRadius = 0;
		circleVelocity[] = {0,0,0};
	...
	class A10_BodyTrailMed: Default
	{
		interval = "0.0001 * (accelY interpolate [69.9999999,70,-1,1])";
		circleRadius = 0;
		circleVelocity[] = {0,0,0};
...
class A10_WingTrace: Default
	...
	class A10_WingTraceMed: Default
	{
		interval = "0.0001 * (accelY interpolate [99.9999999,90,-1,1])";
		circleRadius = 0;
		circleVelocity[] = {0,0,0};
...
class A10_WingVortices
{
	class A10_WingTrail1
	{
		simulation = "particles";
		type = "A10_WingTrail";
		qualityLevel = 2;
	};
	class A10_WingTrail1Med
	{
		simulation = "particles";
		type = "A10_WingTrailMed";
		qualityLevel = 1;
	};
};

class A10_BodyVortices
{
	class A10_BodyTrail1
	{
		simulation = "particles";
		type = "A10_BodyTrail";
		qualityLevel = 2;
	};
	class A10_BodyTrail1Med
	{
		simulation = "particles";
...
class A10_WingTraces
{
	class A10_WingTrace1
	{
		simulation = "particles";
		type = "A10_WingTrace";
		qualityLevel = 2;
	};
	class A10_WingTrace1Med
	{
		simulation = "particles";
