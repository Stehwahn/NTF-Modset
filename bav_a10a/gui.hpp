...
class Controls
{
	...
	class a10_picture_background: RscPicture
	{
		...
		w = 0.7 * safezoneW;
		h = 0.7 * safezoneH;
		text = "FIR_A10A\ui\background_ca.paa";
	};
	class a10pic: RscPicture
	{
		idc = 1201;
		text = "FIR_A10A\ui\a10_loadout_ca.paa";
	...
	{
		idc = 1203;
		text = "FIR_A10A\ui\button_skin.paa";
	...
	{
		idc = 1204;
		text = "FIR_A10A\ui\button_repair.paa";
		x = 0.73625 * safezoneW + safezoneX;
	...
	class repair_btn: RscButton
	{
		...
		action="_applyhandle = execVM ""\FIR_A10A\sqs\loadout\A10_repair.sqf""";
	};
	class A10_refuel_Button: RscPicture
	{
		idc = 1205;
		text = "FIR_A10A\ui\button_refuel.paa";
		x = 0.73625 * safezoneW + safezoneX;
	...
	class refuel_btn: RscButton
	{
		...
		action="_applyhandle = execVM ""\FIR_A10A\sqs\loadout\A10_refuel.sqf""";
	};
	...
	{
		idc = 1706;
		text = "FIR_A10A\ui\button_save1_ca.paa";
		x = 0.73625 * safezoneW + safezoneX;
	...
	class save1_btn: RscButton
	{
		...
		action="_custom1handle = execVM ""\FIR_A10A\sqs\loadout\A10_SaveCustom.sqf""";
	};
	...
	class hp1_c: RscCombo
	{
		...
		w = 0.07875 * safezoneW;
		h = 0.028 * safezoneH;
		/*onLBSelChanged = "_applyhandle = [1] execVM ""\FIR_A10A\sqs\loadout\A10_HARDPOINT.sqf""";*/
	};
	...
	class hp11_c: RscCombo
	{
		...
		w = 0.07875 * safezoneW;
		h = 0.028 * safezoneH;
	/*	onLBSelChanged = "_applyhandle = [11] execVM ""\FIR_A10A\sqs\loadout\A10_HARDPOINT.sqf""";*/
	};
	class a10_name_Button: RscPicture
	{
		idc = 1709;
		text = "FIR_A10A\ui\button_name_ca.paa";
		x = 0.73625 * safezoneW + safezoneX;
		y = 0.654 * safezoneH + safezoneY;
		w = 0.02625 * safezoneW;
		h = 0.042 * safezoneH;
	...
	{
		idc = 1902;
		text = "FIR_A10A\ui\button_apply.paa";
	...
	class apply_btn: RscButton
	{
		...
		action="_applyhandle = execVM ""\FIR_A10A\sqs\loadout\A10_Loadout.sqf""";
	};
	class a10_Cancel_Button: RscPicture
	{
		idc = 1903;
		text = "FIR_A10A\ui\button_cancel.paa";
